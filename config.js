const topBarCenterText = `K2MMT - DM14tg`;
// Menu items
...
const aURL = [
  ...
  ["ff9100", "Refresh", "#", "1"],
  ["0dd1a7", "Help", "#", "1"],
  ["2196F3", "CLUBLOG", "https://clublog.org/livestream/k2mmt", "1.7"],
  [
    "2196F3",
    "CONTEST",
  ...
  [
    "2196F3",
    "WEATHER",
    "https://openweathermap.org/weathermap?basemap=map&cities=true&layer=temperature&lat=37.0902&lon=-95.7154749&zoom=5",
    "1",
    "R",
  ],
  [
    "2196F3",
    "WINDS",
    "https://earth.nullschool.net/#current/wind/surface/level/orthographic=-98.50,37.74,2720",
    "1",
    "R",
  ],
];
...
const tileDelay = [600000,600000,60000,30000,600000,600000,15000,15000,15000,15000,15000,30000];
